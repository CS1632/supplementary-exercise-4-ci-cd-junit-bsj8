...
public class RentACatTest {
	...
	public void testCatAvailableFalseNumCats0() {
		...
		assertFalse("return  is not false",result);
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		r.rentCat(3);
		Boolean result=r.catAvailable(2);
		assertTrue("return  is not True",result);
	}
	...
	public void testListCatsNumCats3() {
		...
		r.addCat(c2);
		r.addCat(c3);
		String callList = r.listCats();
		//System.out.println(callList);
		//Boolean matches = "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n".equals("ID " + "1" + "." + " Jennyanydots" + "\n" + "ID " + "2" + "." + " Old Deuteronomy" + "\n" + "ID " + "3" + "." + " Mistoffelees" + "\n");
		Boolean matches = "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n".equals(callList);
